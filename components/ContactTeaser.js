        ...
        <Reveal delay={140} className="rounded-[22px] border border-line bg-white p-[clamp(24px,3.4vw,38px)] shadow-[0_18px_44px_rgba(20,18,26,.06)]">
          {sent ? (
            <div className="flex animate-tm-slide-down-med flex-col items-start gap-[14px] py-[28px]">
              ...
              <p className="text-[15px] leading-[1.6] text-muted">A consultant will call you within one working day.</p>
            </div>
          ) : (
            <form onSubmit={onSubmit} className="flex flex-col gap-[14px]">
              ...
              <p className="text-[12.5px] leading-[1.55] text-muted-2">
                Or see full details, office address and more help topics on the{' '}
                <a href="/contact" className="font-semibold text-ink hover:text-brand">
                  Contact page
                </a>
                .
              </p>
